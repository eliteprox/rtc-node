...
class WhepFrameBridge:
    """
    Thread-safe buffer that stores the most recent frame received from the trickle subscriber.

    The subscriber (running inside an asyncio loop) calls `put_frame`
